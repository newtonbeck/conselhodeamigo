...
class AdviceTest {
    ...
    public void a_new_advice_should_contain_the_provided_content() {
        Advice advice = new Advice("Most decisions are reversible", "Mr Nobody", Type.WORK);
    ...
    public void a_new_advice_should_contain_the_provided_type() {
        Advice advice = new Advice("Most decisions are reversible", "Mr Nobody", Type.WORK);
        assertEquals(Type.WORK, advice.getType());
    }
    ...
    public void a_new_advice_should_know_when_it_was_created() {
        ...
        Advice advice = new Advice("Most decisions are reversible", "Mr Nobody", Type.WORK, fixedClock);
